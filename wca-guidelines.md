...
- 11d1+) [EXAMPLE] Examples of incidents where it is appropriate to waive a penalty: touching a camera during inspection (see [Regulation 2i2b](regulations:regulation:2i2b)), lightly touching a puzzle at the end of the attempt (see [Regulation A6e](regulations:regulation:A6e)).
...
- H1+) [ADDITION] If a duplicate puzzle is found during an attempt, the cube puzzle be re-scrambled using an unused scramble, at the discretion of the WCA Delegate.
