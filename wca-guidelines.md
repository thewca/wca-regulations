...
- A7c++) [ADDITION] Video or photographic analysis should not be used to correct a result that a judge wrote incorrectly if the competitor signed the score sheet and the correction would improve the result.
