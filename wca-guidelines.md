...
- B4c+) [ADDITION] An attempt should not be disqualified solely due to the judge not putting a sight blocker. However, the WCA Delegate may replace the attempt with an extra attempt if they have a reason to suspect that the competitor received an unfair advantage.
