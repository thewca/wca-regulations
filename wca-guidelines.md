...
- A3c2+) [ADDITION] The competitor must not misalign or further misalign the puzzle even if the misalignment will stay within the limits of [Regulation 10f](regulations:regulation:10f). Penalty: disqualification of the attempt (DNF), at the discretion of the judge.
