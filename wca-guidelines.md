...
- 9f1++) [ADDITION] For 3x3x3 Multi-Blind, the judge should write down the number of puzzles solved, the number of puzzles attempted, and the final time. For example, if the competitor solves 3 cubes out of 5 attempted cubes in 40 minutes, the judge should write down 3/5 40:00
