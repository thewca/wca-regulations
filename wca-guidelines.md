...
- H1+) [ADDITION] If a duplicate puzzle is found during an attempt, the puzzle may be re-scrambled using a scramble not used for this attempt, at the discretion of the WCA Delegate.
