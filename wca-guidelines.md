...
- 7f2+) [CLARIFICATION] Attempts done with an unattached timer should not be replaced or disqualified if it went unnoticed when the attempt was finished and the competitor gained no advantage from it.
