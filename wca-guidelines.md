...
- A1a2++++++) [CLARIFICATION] If a round has a cumulative time limit applied to a combination of rounds for different events, the order of which the attempts are done is the order of the individual time limits counting towards the cumulative time limit.
