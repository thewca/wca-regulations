...
Некоторые термины были намеренно не переведены, потому что в русском языке нет соответствующих слов, или потому, что даже в российских турнирах используются английские названия. К ним относятся: скрамблёр (человек, который смешивает головоломки), Square-1, Clock (названия головоломок), и т.д.
...
- 9r) Квалификационный раунд должен быть проведён до первого раунда дисциплины.
  ...
  - 9r3) Квалификационный раунд может быть добавлен специально для вновь зарегистрированных участников, и/или максимальное число участников в квалификационном раунде или первом раунде дисциплины может быть увеличено. Эти изменения должны быть сделаны минимум за две недели до соревнования.
