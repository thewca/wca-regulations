...
- 4f) Competition scramble sequences must be generated using the current official version of the official WCA scramble program (available [via the WCA website](http://worldcubeassociation.org/regulations/scrambles/)).
