...
- 1b) Команда организаторов несёт ответственность за материально-техническое обеспечение до, во время и после чемпионата.
...
- 2s) Участники с нарушениями, которые могут не позволить им выполнить одно или несколько Положений WCA, могут запросить у WCA Делегата специальные условия. Участникам, запрашивающим такие условия, следует связаться с командой организаторов и WCA Делегатом по крайней мере за две недели до соревнования.
...
- 4b) Головоломки должны быть перемешаны с помощью сгенерированных на компьютере скрамблов.
  ...
  - 4b2) Скрамблы раунда должны быть доступны только WCA Делегату и скрамблёрам дисциплины до окончания раунда. Исключение: Для дисциплины на количество ходов участники получают скрамблы во время раунда (см [Статью E](regulations:article:E)).
...
- 8a) Официальное WCA соревнование:   (криво получается, все пункты нельзя продолжить после фразы "соревнование должно")
