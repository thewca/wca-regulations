...
- A2) Перемешка головоломок:
  ...
  - A2c) После того, как скрамблёр начал перемешивать головоломку, участник не должен её видеть до начала преинспекции.
    - A2c1) Скрамблёр закрывает головоломку накрывашкой, чтобы ни участнику, ни зрителям не было видно никакой её части. Эта накрывашка закрывает головоломку, пока не начнётся попытка.
  ...
  - A2e) Судья ставит головоломку на мат в произвольной ориентации и проверяет, что она полностью закрывается накрывашкой. Участнику не разрешается заказывать ориентацию, в которой будет его головоломка.
- A3) Преинспекция:
