...
- A6) Stopping the solve:
    ...
    - A6e) The competitor must not touch or move the puzzle until the judge has inspected the puzzle and told the result (see [Regulation A7a1](regulations:regulation:A7a1)). Penalty: disqualification of the attempt (DNF). Exception: If no moves have been applied, a time penalty (+2 seconds) may be assigned instead, at the discretion of the judge.
