...
- 2i) While competing, competitors must not use electronics or audio equipment (e.g. cell phones, MP3 players, dictaphones, additional lighting) apart from the Stackmat timer or stopwatch.
    ...
    - 2i3) Exception: the competitor may have a cell phone in their pocket, as long as it is out of their sight and it is clear that they are not interacting with it (apart from it being on their person).
