...
- 9p) If an event has multiple rounds, then:
    ...
    - 9p2+) [CLARIFICATION] Result refers to the single or average that determines the ranking of the corresponding round.
        ...
        - 9p2a++) [REMINDER] An additional round may not be added after a Head to Head round, since that Head to Head round would then no longer be the final round of an event (see [Regulation 9b7b](regulations:regulation:9b7b)).
