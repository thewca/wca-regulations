...
- A6) Stopping the solve:
    ...
    - A6g) The judge determines whether the puzzle is solved. They must not touch the puzzle before they have determined the state of the puzzle. Exception: For Clock, the judge will usually need to pick up the puzzle to verify both faces.
