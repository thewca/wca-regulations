...
- A6) Stopping the solve:
    ...
    - A6f) The competitor must not reset the timer until both the competitor and the judge has signed the result on the score sheet. Penalty: disqualification of the attempt (DNF), at the discretion of the judge.
