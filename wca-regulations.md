...
- E3) The competitor may use the following objects during the attempt. Penalty for using unauthorized objects: disqualification of the attempt (DNF).
    - E3a) Paper (supplied by the judge) with a picture of the scramble for that attempt, the solution sheet (supplied by the judge), and pens/pencils or similar (supplied by the judge, or optionally self-supplied).
