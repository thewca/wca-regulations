...
- 2j) The WCA Delegate may disqualify a competitor from a specific event.
    ...
    - 2j2) If a competitor is disqualified during the course of an event, the results from attempts that are already completed when the competitor is disqualified remain valid. Exception: cheating or defrauding (see [Regulation 2k2a](regulations:regulation:2k2a)).
