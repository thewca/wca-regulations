...
- A1) Speed Solving attempts must abide by the following procedures.
    ...
    - A1b) If the time limit for an attempt is greater than 10 minutes, a stopwatch must be used for timekeeping.
        ...
        - A1b2) If a time from the Stackmat timer is available, it is the original recorded time. Otherwise (e.g. the Stackmat timer malfunctioned or ran for over 10 minutes), the stopwatch time is the original recorded time.
