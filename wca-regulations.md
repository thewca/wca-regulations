...
- 2u) Competitors must be present and ready to compete when they are called to compete for an attempt. Penalty: disqualification from the event.
    ...
    - 2u2) Exception: For rounds with a cumulative time limit, 3x3x3 Fewest Moves, or 3x3x3 Multi-Blind, a competitor who arrives late may compete with a reduced cumulative time limit, at the discretion of the WCA Delegate.
