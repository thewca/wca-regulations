...
- 4d) Scrambling orientation:
    - 4d1) NxNxN puzzles and Megaminx are scrambled starting with the white face (if not possible, then the lightest face) on the top and the darkest green face (if not possible, then the darkest adjacent face) on the front.
