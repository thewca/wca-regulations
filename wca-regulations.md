...
- A4) Starting the solve:
    ...
    - A4d) If a Stackmat timer is in use, the competitor should keep their hands on the timer until they see that a green timer light. They start the solve by removing their hands from the timer (thus starting the timer).
