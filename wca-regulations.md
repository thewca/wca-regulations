...
- 5b) If a puzzle defect occurs during an attempt, the competitor may choose to either repair the defect and continue the attempt, or to stop the attempt.
    ...
    - 5b6) Definition: A part is a subset of puzzle components that can physically hold together (e.g. an individual piece, cap, single sticker, or sticker attached to another part).
