...
- 2g) Competitors must remain quiet when inside the designated competition area. Talking is permitted, but must be kept at a reasonable level, and away from competitors who are actively competing.
    - 2g3) Competitors must not communicate with each other about the scrambled states of the puzzles of the group/round in progress. Penalty: disqualification of the competitor(s) from the event, at the discretion of the WCA Delegate. Exception: For 3x3x3 Fewest Moves, competitors that have finished their attmpet may discuss their solution with other competitors that have finished their attempt (see the regulations for [Article E](regulations:article:E) and the guidelines for [Article E](guidelines:article:E)).
